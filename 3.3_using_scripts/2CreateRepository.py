...
generate_and_write_rsa_keypair("keystore/targets/targets_key")
generate_and_write_rsa_keypair("keystore/release/release_key")
generate_and_write_rsa_keypair("keystore/timestamp/timestamp_key")
